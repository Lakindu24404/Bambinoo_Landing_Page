    ...
    cards: [
      {
        ...
        link: "https://www.mayoclinic.org/healthy-lifestyle/pregnancy-week-by-week/in-depth/prenatal-care/art-20044882",
      },
      {
        title: "Fetal Development",
        desc: "Understanding your baby's growth stages month by month",
        link: "https://www.zerotothree.org/resource/before-birth-prenatal-development-for-baby-mom-and-dad/",
      },
      {
        title: "Preparing for Birth",
        desc: "Hospital bags, birth plans, and what to expect",
        link: "https://mcpress.mayoclinic.org/pregnancy/planning-and-nesting-what-do-you-actually-need/",
      },
      {
        title: "Mental Health",
        desc: "Managing stress and emotions during pregnancy",
        link: "https://www.mayoclinic.org/healthy-lifestyle/pregnancy-week-by-week/in-depth/depression-during-pregnancy/art-20237875",
      },
    ],
  },
  "0-3": {
    ...
    cards: [
      ...
      },
      {
        ...
        link: "https://www.cdc.gov/vaccines-children/index.html",
      },
      {
        title: "Sleep Patterns",
        desc: "Establishing healthy sleep routines",
        link: "https://mcpress.mayoclinic.org/parenting/the-sleep-episode-for-both-you-and-your-infant/",
      },
      {
        title: "Bonding",
        desc: "Building emotional connections with your baby",
        link: "https://www.zerotothree.org/resource/the-importance-of-responsive-parenting-building-strong-emotional-bonds-from-birth/",
      },
    ],
  },
  "3-12": {
    ...
    cards: [
      {
        ...
        link: "https://www.mayoclinic.org/healthy-lifestyle/infant-and-toddler-health/in-depth/healthy-baby/art-20046200",
      },
      {
        title: "Motor Skills",
      ...
      },
      {
        ...
        link: "https://www.zerotothree.org/resource/lets-talk-about-it-5-ways-to-build-babies-language-and-communication-skills-from-birth/",
      },
      {
        title: "Safety Tips",
        desc: "Babyproofing your home",
        link: "https://www.cdc.gov/act-early/milestones/1-year.html",
      },
    ],
  },
  "1-2": {
    ...
    cards: [
      ...
      {
        title: "Balanced Diet",
        desc: "Nutrition for active toddlers",
        link: "https://www.mayoclinic.org/healthy-lifestyle/childrens-health/in-depth/nutrition-for-kids/art-20049335",
      },
      {
        title: "Social Skills",
        desc: "Interaction with other children",
        link: "https://www.cdc.gov/ncbddd/watchmetraining/module2.html",
      },
      {
    ...
    cards: [
      {
        ...
        link: "https://www.zerotothree.org/resource/encouraging-school-readiness-from-birth-to-3/",
      },
      {
        title: "Emotional Intelligence",
        desc: "Understanding and managing emotions",
        link: "https://www.zerotothree.org/resource/tips-on-temperament/",
      },
      {
        title: "Physical Activities",
        desc: "Sports and exercise for young children",
        link: "https://www.cdc.gov/physical-activity-education/staying-healthy/summer.html",
      },
      {
        title: "Healthy Habits",
        desc: "Establishing lifelong wellness routines",
        link: "https://www.cdc.gov/healthy-weight-growth/tips-parents-caregivers/index.html",
      },
    ],
  },
};
...
educationItems.forEach((item) => {
  item.addEventListener("click", () => {
    ...
    contentCards.innerHTML = data.cards
      .map(
        (card) => `
                    <a href="${card.link}" target="_blank" class="content-card-wrapper">
...
if (chatWidget) {
  chatWidget.addEventListener("click", () => {
    ...
    newMessage.innerHTML = "<strong>Doctor:</strong> How can I help you today?";
